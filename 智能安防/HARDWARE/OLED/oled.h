...
#define OLED_SCLK_Clr() GPIO_ResetBits(GPIOC,GPIO_Pin_0)//SCL
#define OLED_SCLK_Set() GPIO_SetBits(GPIOC,GPIO_Pin_0)

#define OLED_SDIN_Clr() GPIO_ResetBits(GPIOC,GPIO_Pin_1)//SDA
...
#define SCL_W PDout(5)

#define SDA_W PDout(4)
#define SDA_R PDin(4)
