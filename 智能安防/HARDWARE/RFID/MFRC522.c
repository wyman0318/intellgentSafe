...
{ 
	...
	//配置引脚PB3 PB4 PB5 为复用功能模式
	GPIO_InitStruct.GPIO_Pin=GPIO_Pin_3;//第9 10引脚
	GPIO_InitStruct.GPIO_Mode=GPIO_Mode_IN;			//复用功能模式
	...
	//配置引脚PB0为输出模式
	GPIO_InitStruct.GPIO_Pin=GPIO_Pin_2|GPIO_Pin_4;//第9 10引脚
	GPIO_InitStruct.GPIO_Mode=GPIO_Mode_OUT;			//复用功能模式
	GPIO_InitStruct.GPIO_Speed=GPIO_High_Speed;		//引脚高速工作，收到指令立即工作；缺点：功耗高
	GPIO_InitStruct.GPIO_OType=GPIO_OType_PP;		//增加输出电流的能力
	GPIO_InitStruct.GPIO_PuPd=GPIO_PuPd_NOPULL;		//不需要上下拉电阻
	GPIO_Init(GPIOC,&GPIO_InitStruct);
	...
	//配置引脚PB0为输出模式
	GPIO_InitStruct.GPIO_Pin=GPIO_Pin_0|GPIO_Pin_1;//第9 10引脚
	GPIO_InitStruct.GPIO_Mode=GPIO_Mode_OUT;			//复用功能模式
	GPIO_InitStruct.GPIO_Speed=GPIO_High_Speed;		//引脚高速工作，收到指令立即工作；缺点：功耗高
	GPIO_InitStruct.GPIO_OType=GPIO_OType_PP;		//增加输出电流的能力
	GPIO_InitStruct.GPIO_PuPd=GPIO_PuPd_NOPULL;		//不需要上下拉电阻
